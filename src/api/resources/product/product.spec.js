...
describe('Product', () => {
  ...
  it('should get one', async () => {
    ...
    const val = await productModel.create(product);
  ...
  it('should add one size to product', async () => {
    ...
    const CREATE_ONE_PRODUCT_SIZE = gql`
