import { userModel, userMeta } from './user.model';
...
describe.skip('User', () => {
  ...
  it('should get one user', async () => {
    ...
    const val = await userModel.create(users);
